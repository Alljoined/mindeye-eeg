...
import utils
from models import Clipper, BrainDiffusionPrior, BrainDiffusionPriorOld, VersatileDiffusionPriorNetwork
...
parser.add_argument(
    "--data_path", type=str, default="/workspace/eeg_reconstruction/shared/natural-scenes-dataset",
